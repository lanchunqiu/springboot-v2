...
public class Chapter14WebClient {
    ...
    public static void main(String[] args) {
        //创建一个WebClient对象，并且设置请求基础路径
        WebClient client = WebClient.create("http://localhost:5555");

        //一个新用户
//        User newUser = new User();
//        newUser.setId(2L);
//        newUser.setNote("note_new2");
//        newUser.setUserName("user_name_new2");
